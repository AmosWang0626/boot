...
public class RandomUtil {
    ...
    private static final String LUCKY_NUMBER_CHAR = "012356789";
     ...
     * @return 随机字符串
     */
    public static String generateLuckyNumberString(int length) {
        StringBuffer sb = new StringBuffer();
        Random random = new Random();
        for (int i = 0; i < length; i++) {
            sb.append(LUCKY_NUMBER_CHAR.charAt(random.nextInt(LUCKY_NUMBER_CHAR.length())));
        }
        return sb.toString();
    }
